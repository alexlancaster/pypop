...
generated_filenames_common = [
    ...
    "BIGDAWG_SynthControl_Data-out.xml",
    "meta.xml",
]
...
def test_GenerateTSV_2_locus():
    exit_code = run_pypop_process(
        "./tests/data/WS_BDCtrl_Test_EM_2_locus.ini",
    ...
    assert filecmp_list_of_files(
        checked_filenames, DEFAULT_GOLD_OUTPUT_DIR / "generate_tsv_2_locus"
    )
...
def test_GenerateTSV_2_locus_with_HW():
    exit_code = run_pypop_process(
        "./tests/data/WS_BDCtrl_Test_EM_plus_HW_2_locus.ini",
        "./tests/data/BIGDAWG_SynthControl_Data.pop",
        args=args_common,
    )
    # check exit code
    ...
    # compare specific files
    assert filecmp_list_of_files(
        checked_filenames, DEFAULT_GOLD_OUTPUT_DIR / "generate_tsv_2_locus_with_HW"
    )
...
def test_GenerateTSV_3_locus():
    ...
    assert filecmp_list_of_files(
        checked_filenames, DEFAULT_GOLD_OUTPUT_DIR / "generate_tsv_3_locus"
    )
...
def test_GenerateTSV_4_locus():
    exit_code = run_pypop_process(
        "./tests/data/WS_BDCtrl_Test_EM_4_locus.ini",
        "./tests/data/BIGDAWG_SynthControl_Data.pop",
        args=args_common,
    )
    # check exit code
    ...
    # compare with output files
    assert filecmp_list_of_files(
        checked_filenames, DEFAULT_GOLD_OUTPUT_DIR / "generate_tsv_4_locus"
    )
...
def test_GenerateTSV_3_and_4_locus():
    exit_code = run_pypop_process(
        "./tests/data/WS_BDCtrl_Test_EM_3_and_4_locus.ini",
        "./tests/data/BIGDAWG_SynthControl_Data.pop",
        args=args_common,
    )
    # check exit code
    ...
    # compare with output files
    assert filecmp_list_of_files(
        checked_filenames, DEFAULT_GOLD_OUTPUT_DIR / "generate_tsv_3_and_4_locus"
    )
...
def test_GenerateTSV_5_locus():
    exit_code = run_pypop_process(
        "./tests/data/WS_BDCtrl_Test_EM_5_locus.ini",
        "./tests/data/BIGDAWG_SynthControl_Data.pop",
        args=args_common,
    )
    # check exit code
    ...
    # compare with output files
    assert filecmp_list_of_files(
        checked_filenames, DEFAULT_GOLD_OUTPUT_DIR / "generate_tsv_5_locus"
    )
