...
{% set normal_submodules = [] %}
{% set deprecated_submodules = [] %}
{% for submodule in visible_submodules %}
    {% if submodule.docstring and "deprecated" in submodule.docstring %}
        {% set _ = deprecated_submodules.append(submodule) %}
    {% else %}
        {% set _ = normal_submodules.append(submodule) %}
    {% endif %}
{% endfor %}

{% if normal_submodules %}
Submodules
----------
...
.. toctree::
   :maxdepth: 1
            ...
            {% for submodule in normal_submodules %}
...
.. toctree::
   ...
   {% for submodule in deprecated_submodules %}
   {{ submodule.name }} - DEPRECATED <{{ submodule.include_path }}>
   {% endfor %}
{% endif %}
