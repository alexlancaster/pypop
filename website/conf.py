...
html_theme_options = { # these are both piccolo theme-specific
    ...
    "banner_text": 'Pre-release beta version of PyPop 1.0.0 is now available! See <a href="https://github.com/alexlancaster/pypop#readme">README</a> for installing pre-releases via PyPI or for compiling from source'
}
